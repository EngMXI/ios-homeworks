...
protocol PostTableViewCellDelegate: AnyObject {
    func addLikes(_ gesture: UITapGestureRecognizer)
    func addViews(_ gesture: UITapGestureRecognizer)
}
...
class PostTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let likesLabelTap = UITapGestureRecognizer(target: self, action: #selector(self.addLikes))
        self.likesLabel.addGestureRecognizer(likesLabelTap)
        
        let postImageViewTap = UITapGestureRecognizer(target: self, action: #selector(self.addViews))
        self.imageImageView.addGestureRecognizer(postImageViewTap)
