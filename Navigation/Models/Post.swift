...
let myPosts: [Post] = [Post(author: "Здоровье \nсемьи", description: "Казанская сеть клиник сделала консультации ведущих врачей Татарстана и России доступными каждому", image: "01", likes: 20, views: 100),
